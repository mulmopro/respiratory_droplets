...
#include "PBEInterfaceCompositionPhaseChangePhaseSystem.H"
...
Foam::PBEInterfaceCompositionPhaseChangePhaseSystem<BasePhaseSystem>::
dmdtfs() const
{
...
template<class BasePhaseSystem>
Foam::PBEInterfaceCompositionPhaseChangePhaseSystem<BasePhaseSystem>::
PBEInterfaceCompositionPhaseChangePhaseSystem
(
    const fvMesh& mesh
)
:
...
Foam::PBEInterfaceCompositionPhaseChangePhaseSystem<BasePhaseSystem>::dmdtf
(
...
Foam::PBEInterfaceCompositionPhaseChangePhaseSystem<BasePhaseSystem>::dmdts() const
{
...
template<class BasePhaseSystem>
void Foam::PBEInterfaceCompositionPhaseChangePhaseSystem<BasePhaseSystem>::
correct()
{
...
template<class BasePhaseSystem>
bool Foam::PBEInterfaceCompositionPhaseChangePhaseSystem<BasePhaseSystem>::read()
{
