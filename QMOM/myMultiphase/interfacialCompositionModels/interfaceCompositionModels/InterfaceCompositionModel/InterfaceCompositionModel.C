...
:
    ...
    (
        ...
        */
        pair.continuous().mesh().lookupObject<Thermo>
        (
            IOobject::groupName(basicThermo::dictName, pair.continuous().name())
        )
    ),
    otherThermo_
    (
        ...
        */
        pair.dispersed().mesh().lookupObject<OtherThermo>
        (
            IOobject::groupName(basicThermo::dictName, pair.dispersed().name())
        )
    ),
    Le_("Le", dimless, dict)
{}
