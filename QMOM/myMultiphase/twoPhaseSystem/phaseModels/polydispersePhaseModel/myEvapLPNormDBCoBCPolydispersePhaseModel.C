...
#include "myEvapLPNormDBCoBCPolydispersePhaseModel.H"
#include "fvMatrix.H"
...
void Foam::myEvapLPNormDBCoBCPolydispersePhaseModel<BasePhaseModel>::updateVelocity()
{
...
template<class BasePhaseModel>
Foam::scalar Foam::myEvapLPNormDBCoBCPolydispersePhaseModel<BasePhaseModel>::coalescenceSource
(
    const label celli,
...
template<class BasePhaseModel>
Foam::vector Foam::myEvapLPNormDBCoBCPolydispersePhaseModel<BasePhaseModel>::coalescenceSourceU
(
    const label celli,
    const label momentOrder
)
...
template<class BasePhaseModel>
Foam::scalar Foam::myEvapLPNormDBCoBCPolydispersePhaseModel<BasePhaseModel>::breakupSource
(
    const label celli,
    const label momentOrder
)
...
template<class BasePhaseModel>
Foam::vector Foam::myEvapLPNormDBCoBCPolydispersePhaseModel<BasePhaseModel>::breakupSourceU
(
    const label celli,
    const label momentOrder
)
...
template<class BasePhaseModel>
void Foam::myEvapLPNormDBCoBCPolydispersePhaseModel<BasePhaseModel>::solveSourceOde()
{
...
template<class BasePhaseModel>
Foam::myEvapLPNormDBCoBCPolydispersePhaseModel<BasePhaseModel>::myEvapLPNormDBCoBCPolydispersePhaseModel
(
...
template<class BasePhaseModel>
void Foam::myEvapLPNormDBCoBCPolydispersePhaseModel<BasePhaseModel>::setModels()
{
...
template<class BasePhaseModel>
void Foam::myEvapLPNormDBCoBCPolydispersePhaseModel<BasePhaseModel>::correct()
{
...
template<class BasePhaseModel>
void Foam::myEvapLPNormDBCoBCPolydispersePhaseModel<BasePhaseModel>::relativeTransport()
{
...
template<class BasePhaseModel>
void Foam::myEvapLPNormDBCoBCPolydispersePhaseModel<BasePhaseModel>::averageTransport
(
...
template<class BasePhaseModel>
bool Foam::myEvapLPNormDBCoBCPolydispersePhaseModel<BasePhaseModel>::read(const bool readOK)
{
    bool read = false;
    if (readOK)
    {
