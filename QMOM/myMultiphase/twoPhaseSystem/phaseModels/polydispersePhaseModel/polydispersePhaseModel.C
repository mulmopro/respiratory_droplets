...
void Foam::polydispersePhaseModel<BasePhaseModel>::updateVelocity()
{
...
template<class BasePhaseModel>
Foam::scalar Foam::polydispersePhaseModel<BasePhaseModel>::coalescenceSource
(
    const label celli,
...
template<class BasePhaseModel>
Foam::vector Foam::polydispersePhaseModel<BasePhaseModel>::coalescenceSourceU
(
    const label celli,
    const label momentOrder
)
...
template<class BasePhaseModel>
Foam::scalar Foam::polydispersePhaseModel<BasePhaseModel>::breakupSource
(
    const label celli,
    const label momentOrder
)
...
template<class BasePhaseModel>
Foam::vector Foam::polydispersePhaseModel<BasePhaseModel>::breakupSourceU
(
    const label celli,
    const label momentOrder
)
...
template<class BasePhaseModel>
void Foam::polydispersePhaseModel<BasePhaseModel>::solveSourceOde()
{
...
template<class BasePhaseModel>
Foam::polydispersePhaseModel<BasePhaseModel>::polydispersePhaseModel
(
...
template<class BasePhaseModel>
void Foam::polydispersePhaseModel<BasePhaseModel>::setModels()
{
...
template<class BasePhaseModel>
void Foam::polydispersePhaseModel<BasePhaseModel>::correct()
{
...
template<class BasePhaseModel>
void Foam::polydispersePhaseModel<BasePhaseModel>::relativeTransport()
{
...
template<class BasePhaseModel>
void Foam::polydispersePhaseModel<BasePhaseModel>::averageTransport
(
...
)
{
    ...
    if (corr_.valid())
    {
        ...
        for (label i = 0; i < nCorrectors; i++)
        {
            ...
            (
                ((*this)*this->rho() - quadrature_.moments()[1])
            ...
            corrEqn.relax();
            corrEqn.solve();
            phi += fvc::snGrad(corr)*this->fluid().mesh().magSf();
        }
    }
    quadrature_.interpolateNodes();
...
template<class BasePhaseModel>
bool Foam::polydispersePhaseModel<BasePhaseModel>::read(const bool readOK)
{
    bool read = false;
    if (readOK)
    {
