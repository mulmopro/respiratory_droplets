...
correctInterfaceThermo()
{
    ...
    for (label i = 0; i < nInterfaceCorrectors_; ++ i)
    {
        ...
        // ******
        /*
        Info<< "KM2: " << average(Km2()) << endl
            << "Tf: " << average(Tf) << endl
            << endl;
        Info<< "mDotL: " << average(mDotL) << endl;
        for
        (
            const word& member
            : interfaceCompositionModel2_->species()
        ...
        {
            Info<< "L." << member << ": " << average(interfaceCompositionModel2_->L(member, Tf)) << endl;

            Info<< "Yf." << member << ": " << average(interfaceCompositionModel2_->Yf(member, Tf)) << endl;

            Info<< "Y." << member << ": " << average(this->phase2().Y(member)) << endl;

            Info<< "dY." << member << ": " << average(interfaceCompositionModel2_->dY(member, Tf)) << endl;

            Info<< "D." << member << ": " << average(interfaceCompositionModel2_->D(member)) << endl;

            Info<< "rho: " << average(this->phase2().rho()) << endl;

            Info<< "p" 
                        << ": min = " << min(this->phase2().thermo().p())
                        << ", mean = " << average(this->phase2().thermo().p())
                        << ", max = " << max(this->phase2().thermo().p())
                        << endl;
            Info<< "W" 
                        << ": min = " << min(this->phase2().thermo().W())
                        << ", mean = " << average(this->phase2().thermo().W())
                        << ", max = " << max(this->phase2().thermo().W())
                        << endl;

            Info<< "this->pair().phase1(): " << this->pair().phase1().name() << endl
                << "this->pair().phase2(): " << this->pair().phase2().name() << endl
                << "this->phase1(): " << this->phase1().name() << endl
                << "this->phase2(): " << this->phase2().name() << endl;
        }
        // ******
        */
        ...
        //Info<< "InterfaceCompositionPhaseChangePhaseSystem: " << endl;
        /*
        Info<< "Tf"
...
template<class BasePhaseSystem>
Foam::tmp<Foam::volScalarField>
Foam::InterfaceCompositionPhaseChangePhaseSystem<BasePhaseSystem>::Km2() const
{
...
/*
template<class BasePhaseSystem>
Foam::HashPtrTable<Foam::volScalarField> Foam::InterfaceCompositionPhaseChangePhaseSystem<BasePhaseSystem>::dmidtfs() const
{
...
/*
template<class BasePhaseSystem>
void Foam::InterfaceCompositionPhaseChangePhaseSystem<BasePhaseSystem>::averageTransport()
{
    const phaseModel& phase1 = this->phase1();
    const phaseModel& phase2 = this->phase2();
...
Foam::InterfaceCompositionPhaseChangePhaseSystem<BasePhaseSystem>::getAEqns() const
{
