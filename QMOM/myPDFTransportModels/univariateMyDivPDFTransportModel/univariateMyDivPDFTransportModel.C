...
#include "univariateMyDivPDFTransportModel.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::PDFTransportModels::univariateMyDivPDFTransportModel
::univariateMyDivPDFTransportModel
(
    const word& name,
...
void Foam::PDFTransportModels::univariateMyDivPDFTransportModel::solve()
{
