...
#include "univariateELimitedPopulationBalance.H"
...
{
    defineTypeNameAndDebug(univariateELimitedPopulationBalance, 0);
    addToRunTimeSelectionTable
    (
        populationBalanceModel,
        univariateELimitedPopulationBalance,
        dictionary
    );
}
}
...
Foam::PDFTransportModels::populationBalanceModels::univariateELimitedPopulationBalance
::univariateELimitedPopulationBalance
(
    const word& name,
...
const Foam::scalarQuadratureApproximation& Foam::PDFTransportModels::populationBalanceModels::univariateELimitedPopulationBalance
::quadrature() const
{
    return univariatePDFTransportModel::quadrature();
}
