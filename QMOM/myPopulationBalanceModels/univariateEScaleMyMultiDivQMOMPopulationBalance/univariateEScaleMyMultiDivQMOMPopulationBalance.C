...
#include "univariateEScaleMyMultiDivQMOMPopulationBalance.H"
...
{
    defineTypeNameAndDebug(univariateEScaleMyMultiDivQMOMPopulationBalance, 0);
    addToRunTimeSelectionTable
    (
        populationBalanceModel,
        univariateEScaleMyMultiDivQMOMPopulationBalance,
        dictionary
    );
}
}
...
Foam::PDFTransportModels::populationBalanceModels::univariateEScaleMyMultiDivQMOMPopulationBalance
::univariateEScaleMyMultiDivQMOMPopulationBalance
(
    const word& name,
...
const Foam::scalarQuadratureApproximation& Foam::PDFTransportModels::populationBalanceModels::univariateEScaleMyMultiDivQMOMPopulationBalance
::quadrature() const
{
