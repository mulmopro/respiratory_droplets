...
#include "univariateEScaleMyMultiDivZeroPopulationBalance.H"
...
{
    defineTypeNameAndDebug(univariateEScaleMyMultiDivZeroPopulationBalance, 0);
    addToRunTimeSelectionTable
    (
        populationBalanceModel,
        univariateEScaleMyMultiDivZeroPopulationBalance,
        dictionary
    );
}
}
...
Foam::PDFTransportModels::populationBalanceModels::univariateEScaleMyMultiDivZeroPopulationBalance
::univariateEScaleMyMultiDivZeroPopulationBalance
(
    const word& name,
        ...
        forAll(quadrature_.moments()[1], celli)
        {
            forAll(nodes, pNodeI)
            {
                ...
                forAll(node.secondaryWeights()[sizeIndex], sNodei)
                {
                    ...
                    {
                        //abscissa = minAbscissa;
                        scalar& weight = node.secondaryWeights()[sizeIndex][sNodei][celli];
                        weight = 0.0;
                    }
...
const Foam::scalarQuadratureApproximation& Foam::PDFTransportModels::populationBalanceModels::univariateEScaleMyMultiDivZeroPopulationBalance
::quadrature() const
{
