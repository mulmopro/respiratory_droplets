...
#include "univariateEScaleMyMultiDivNormPopulationBalance.H"
...
{
    defineTypeNameAndDebug(univariateEScaleMyMultiDivNormPopulationBalance, 0);
    addToRunTimeSelectionTable
    (
        populationBalanceModel,
        univariateEScaleMyMultiDivNormPopulationBalance,
        dictionary
    );
}
}
...
Foam::PDFTransportModels::populationBalanceModels::univariateEScaleMyMultiDivNormPopulationBalance
::univariateEScaleMyMultiDivNormPopulationBalance
(
    const word& name,
...
/*
        ...
        quadrature_.moments()[0].mesh().solutionDict().subDict("PIMPLE");
        const dimensionedScalar W = pimpleDict.lookupOrDefault<label>("W", 1.0);
        const dimensionedScalar Xi = pimpleDict.lookupOrDefault<scalar>("Xi", 1.0);
*/
...
const Foam::scalarQuadratureApproximation& Foam::PDFTransportModels::populationBalanceModels::univariateEScaleMyMultiDivNormPopulationBalance
::quadrature() const
{
