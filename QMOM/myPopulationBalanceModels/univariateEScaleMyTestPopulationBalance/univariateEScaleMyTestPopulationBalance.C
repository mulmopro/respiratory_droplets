...
#include "univariateEScaleMyTestPopulationBalance.H"
...
{
    defineTypeNameAndDebug(univariateEScaleMyTestPopulationBalance, 0);
...
Foam::PDFTransportModels::populationBalanceModels::univariateEScaleMyTestPopulationBalance
::univariateEScaleMyTestPopulationBalance
(
    const word& name,
...
const Foam::scalarQuadratureApproximation& Foam::PDFTransportModels::populationBalanceModels::univariateEScaleMyTestPopulationBalance
::quadrature() const
{
