...
::evaporation()
{
    if (evaporation_)
    {
        ...
        volScalarField drift = 2 * dvdtf / (Foam::constant::mathematical::pi * max(quadrature_.moments()[1], MSmall));
...
const Foam::scalarQuadratureApproximation& Foam::PDFTransportModels::populationBalanceModels::univariatePopulationBalance
::quadrature() const
{
