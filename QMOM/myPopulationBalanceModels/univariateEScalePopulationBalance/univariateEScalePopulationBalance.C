...
#include "univariateEScalePopulationBalance.H"
...
{
    defineTypeNameAndDebug(univariateEScalePopulationBalance, 0);
    addToRunTimeSelectionTable
    (
        populationBalanceModel,
        univariateEScalePopulationBalance,
        dictionary
    );
}
}
...
Foam::PDFTransportModels::populationBalanceModels::univariateEScalePopulationBalance
::univariateEScalePopulationBalance
(
    const word& name,
...
const Foam::scalarQuadratureApproximation& Foam::PDFTransportModels::populationBalanceModels::univariateEScalePopulationBalance
::quadrature() const
{
