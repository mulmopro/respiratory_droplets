...
#include "univariateEScaleMyMultiDivPopulationBalance.H"
...
{
    defineTypeNameAndDebug(univariateEScaleMyMultiDivPopulationBalance, 0);
    addToRunTimeSelectionTable
    (
        populationBalanceModel,
        univariateEScaleMyMultiDivPopulationBalance,
        dictionary
    );
}
}
...
Foam::PDFTransportModels::populationBalanceModels::univariateEScaleMyMultiDivPopulationBalance
::univariateEScaleMyMultiDivPopulationBalance
(
    const word& name,
...
const Foam::scalarQuadratureApproximation& Foam::PDFTransportModels::populationBalanceModels::univariateEScaleMyMultiDivPopulationBalance
::quadrature() const
{
